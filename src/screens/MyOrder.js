...
export default function MyOrder() {
    ...
    const fetchMyOrder = async () => {
        await fetch("https://go-food-kartiksaini2410s-projects.vercel.app/api/myOrderData", {
            // credentials: 'include',
    ...
    return (
        <div>
            ...
            <div className='container'>
                ...
                {!_.isEmpty(orderData) && _.map(orderData, data => {
                    return (
                        data.orderData &&
                        _.map(_.reverse(data.orderData.order_data), item => {
                            return (
                                _.map(item, arrayData => {
                                    return (
                                        <div>
